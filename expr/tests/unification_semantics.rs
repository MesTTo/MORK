...
fn unify_to_string(lhs: &mut [u8], rhs: &mut [u8]) -> Result<String, UnificationFailure> {
    ...
    lhs.unify_into(rhs, &mut zipper)?;

    Ok(format!("{:?}", expr_from_bytes(&mut output)))
}

#[test]
fn unify_into_materializes_first_order_mgu() {
...
#[test]
fn unify_into_materializes_same_nested_mgu_from_either_side() {
...
#[test]
fn unify_into_respects_repeated_variable_constraints() {
...
#[test]
fn unify_into_respects_repeated_variable_constraints_on_rhs() {
...
#[test]
fn unify_into_rejects_indirect_occurs_cycles() {
    let mut lhs = parse!(
...
#[test]
fn unify_into_keeps_expression_variable_namespaces_separate() {
    let mut lhs = parse!("$");
...
#[test]
fn unify_into_remains_first_order_syntactic_without_background_evaluation() {
...
#[test]
fn unify_into_reports_symbol_shape_difference() {
...
#[test]
fn unify_into_matches_first_order_occurs_check_oracle_on_finite_terms() {
